...
describe("ClubService getClubs", () => {
  it("returns clubs using the requested semester snapshot", async () => {
    ...
    const service = new ClubService(
      clubOldRepository as unknown as ClubServiceDependencies[0],
      {} as ClubServiceDependencies[1],
      {} as ClubServiceDependencies[2],
      clubStudentTRepository as unknown as ClubServiceDependencies[3],
      {} as ClubServiceDependencies[4],
      divisionPermanentClubDRepository as unknown as ClubServiceDependencies[5],
      {} as ClubServiceDependencies[6],
      {} as ClubServiceDependencies[7],
      clubPublicService as unknown as ClubServiceDependencies[8],
      {} as ClubServiceDependencies[9],
      semesterPublicService as unknown as ClubServiceDependencies[10],
...
describe("ClubService cancelRegistration", () => {
  it("coordinates registration cancellation repositories", async () => {
    ...
    const service = new ClubService(
      ...
      registrationPublicService as unknown as ClubServiceDependencies[9],
      {} as ClubServiceDependencies[10],
      clubSemesterRepository as unknown as ClubServiceDependencies[11],
      clubDelegateRepository as unknown as ClubServiceDependencies[12],
      clubDelegateChangeRequestRepository as unknown as ClubServiceDependencies[13],
      {} as ClubServiceDependencies[14],
    );
    Object.assign(service, { clock: { now: () => now } });
